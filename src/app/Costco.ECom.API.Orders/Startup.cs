...
namespace Costco.ECom.API.Orders
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<ITelemetryInitializer>(sp =>
            {
                ...
                return new AlwaysOnCustomTelemetryInitializer($"{nameof(Orders)}-{sysConfig.AzureRegionShort}", sp.GetService<IHttpContextAccessor>());
            });
            ...
            services.AddApiVersioning(o =>
            {
                ...
                o.DefaultApiVersion = new ApiVersion(OrdersServiceHelpers.DefaultApiVersionMajor, OrdersServiceHelpers.DefaultApiVersionMinor);
            });
        }
